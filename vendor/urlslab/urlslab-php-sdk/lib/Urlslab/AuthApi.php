...
/**
    ...
    /**
     * Operation getAuthIntegrations
     *
     * check if the user is already integrated to a specific integration
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAuthIntegrations'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\DomainUrlslabIntegration[]
     */
    public function getAuthIntegrations(string $contentType = self::contentTypes['getAuthIntegrations'][0])
    {
        list($response) = $this->getAuthIntegrationsWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getAuthIntegrationsWithHttpInfo
     *
     * check if the user is already integrated to a specific integration
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAuthIntegrations'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\DomainUrlslabIntegration[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAuthIntegrationsWithHttpInfo(string $contentType = self::contentTypes['getAuthIntegrations'][0])
    {
        $request = $this->getAuthIntegrationsRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\DomainUrlslabIntegration[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\DomainUrlslabIntegration[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\DomainUrlslabIntegration[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\DomainUrlslabIntegration[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\DomainUrlslabIntegration[]',
    ...
    /**
     * Operation getAuthIntegrationsAsync
     *
     * check if the user is already integrated to a specific integration
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAuthIntegrations'] to see the possible values for this operation
     ...
     */
    public function getAuthIntegrationsAsync(string $contentType = self::contentTypes['getAuthIntegrations'][0])
    {
        return $this->getAuthIntegrationsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAuthIntegrationsAsyncWithHttpInfo
     *
     * check if the user is already integrated to a specific integration
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAuthIntegrations'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAuthIntegrationsAsyncWithHttpInfo(string $contentType = self::contentTypes['getAuthIntegrations'][0])
    {
        $returnType = '\OpenAPI\Client\Model\DomainUrlslabIntegration[]';
        $request = $this->getAuthIntegrationsRequest($contentType);
    ...
    /**
     * Create request for operation 'getAuthIntegrations'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAuthIntegrations'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getAuthIntegrationsRequest(string $contentType = self::contentTypes['getAuthIntegrations'][0])
    {


        $resourcePath = '/v1/auth/integrations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
