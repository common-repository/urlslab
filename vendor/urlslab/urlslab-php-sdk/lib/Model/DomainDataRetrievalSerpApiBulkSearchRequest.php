<?php
/**
 * DomainDataRetrievalSerpApiBulkSearchRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DomainDataRetrievalSerpApiBulkSearchRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DomainDataRetrievalSerpApiBulkSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'domain.dataRetrieval.SerpApiBulkSearchRequest';
    ...
    */
    ...
    {
        return $this->container['serp_queries'];
    }
     ...
     * @return self
     */
    public function setSerpQueries($serp_queries)
    {
        if (is_null($serp_queries)) {
