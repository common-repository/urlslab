...
/**
 * DomainUrlslabIntegration Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DomainUrlslabIntegration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'domain.UrlslabIntegration';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_integrated', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_integrated'] === null) {
            $invalidProperties[] = "'is_integrated' can't be null";
        }
    ...
    {
        if (is_null($is_integrated)) {
            throw new \InvalidArgumentException('non-nullable is_integrated cannot be null');
        }
